...
Quality Assessment of the RNA samples can be found [here](./QualityAssessment.pdf). The RNA Integrity Number (RIN) value has a maximum value of 10.
\
")
...
datatable(df_DE_selected, caption = "Final list DeSEQ2", colnames= c("Sample Name", "Secondary Name", "% Assigned", "Assigned", "% Aligned", "% Trimmed", "% Dups", "% GC", "Seqs"), extensions = c('Buttons', 'FixedColumns'), "Autofill", options = list(dom = 'Bfrtip', scrollX = T, scrollCollapse = T, buttons = c('copy', 'csv', 'excel', 'pdf', 'print'), pageLength = 10)) #args not working: lengthMenu = c(5, 10, 20, n_rows)))
```
...
print(config$outlook, quote = FALSE)
```
